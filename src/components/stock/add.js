...
var Add = React.createClass({
	...
	onVoise:function (argument) {
	    BaiduVoise.api_key='q0UcNM0glvjekMtBQNWzM92y';
	    BaiduVoise.secret_key='8hRsMQCQGNdwqnyF8GkWBgr6WObZFT5l';
		...
		return (
		  <View style={styles.container}>
		  	<Titlebar style={styles.title} showBack={true}>
		  		<TextInput ref={(n)=>this._input=n} onChangeText={this.onInputChange} underlineColorAndroid={'#fff'} keyboardType={'default'} 
		  	...
		  	<ScrollView keyboardShouldPersistTaps={true} style={{flex:2}}>		  		
			  	...
			  	<BaiduVoise 
					...
					onReceive={this.onReceive}>   
			  		<View style={styles.voiseBtn}>
			  			<Icon key={"1"} name={"fontawesome|microphone"} size={40} color={"WHITE"} style={styles.voiseIcon} /> 
			  		</View>		  		 
		        </BaiduVoise> 
		  	</View>
		  </View>
