var ma={
    ...
    calculate: function (newData) {
        ...
        for (me.i; me.i < me.data.length; me.i++) {
            ...
            ma.push([me.data[me.i][0],Number( me.ma1[me.i].toFixed(2)),Number( me.ma2[me.i].toFixed(2)),Number(me.ma3[me.i].toFixed(2)),Number(me.ma4[me.i].toFixed(2))]);
        }
        return ma;
    },
    ...
    getChartData:function(price){
        ...
        var allData=this.calculate(price);
